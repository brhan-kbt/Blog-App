...
import 'package:sheger_tech/modules/settings/pages/about_page.dart';
import 'package:sheger_tech/modules/settings/pages/contact_us_page.dart';
import 'package:sheger_tech/modules/settings/pages/privacy_policy_page.dart';
import 'package:sheger_tech/modules/settings/pages/publisher_info_page.dart';
import 'package:sheger_tech/modules/settings/pages/push_notification_page.dart';
import 'package:sheger_tech/widgets/privacy_options_button.dart';
        ...
        return ListView(
          ...
          children: [
              ...
              onTap: () async {
                ...
                if (await inAppReview.isAvailable()) {
                  ...
                  inAppReview.openStoreListing(
                    appStoreId: "com.tekopia.sheger_tech", // TODO replace
                  );
                }
              },
            ),
            _SimpleTile(
              ...
              onTap: () {
                Share.share(
                  "Check out Sheger Tech App: https://play.google.com/store/apps/details?id=com.tekopia.sheger_tech",
                );
              },
            ),
            _SimpleTile(
