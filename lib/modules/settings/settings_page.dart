...
import 'package:abayjobs/core/services/reward_service.dart';
...
class SettingsPage extends StatelessWidget {
  ...
  Future<void> _rateApp() async {
    ...
    if (await inAppReview.isAvailable()) {
      ...
      inAppReview.openStoreListing(appStoreId: "com.brhan.abayjobs");
    }
  }

  void _shareApp() {
    Share.share(
      "Check out Abay Jobs App - Your ultimate tech companion! https://play.google.com/store/apps/details?id=com.brhan.abayjobs",
    );
  }
