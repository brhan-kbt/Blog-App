...
import 'package:kelotech/modules/settings/pages/push_notification_page.dart';
import 'package:path_provider/path_provider.dart';
import 'package:kelotech/core/theme/app_palette.dart';
import 'package:kelotech/core/theme/theme_service.dart';
import 'package:kelotech/modules/settings/pages/about_page.dart';
import 'package:kelotech/modules/settings/pages/privacy_policy_page.dart';
import 'package:kelotech/modules/settings/pages/publisher_info_page.dart';
import 'package:kelotech/widgets/privacy_options_button.dart';
...
class SettingsPage extends StatelessWidget {
  ...
  Future<void> _rateApp() async {
    ...
    if (await inAppReview.isAvailable()) {
      ...
      inAppReview.openStoreListing(appStoreId: "com.techomia.kelotech");
    }
  }

  void _shareApp() {
    Share.share(
      "Check out Kelo Tech App - Your ultimate tech companion! https://play.google.com/store/apps/details?id=com.techomia.kelotech",
    );
  }
