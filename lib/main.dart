...
import 'package:freshtips/modules/post_detail/post_detail_page.dart';
...
import 'package:freshtips/firebase_options.dart';
import 'package:freshtips/widgets/adabtiveBanner.dart';
...
import 'package:freshtips/core/services/performance_service.dart';
import 'package:freshtips/core/services/version_check_service.dart';
import 'package:freshtips/core/services/version_check_controller.dart';
import 'package:freshtips/routes/app_pages.dart';
...
class FreshTipsApp extends StatelessWidget {
  const FreshTipsApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 FreshTipsApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 FreshTipsApp - IsDark: ${themeSvc.isDark}");
