...
import 'package:qalbitech/modules/post_detail/post_detail_page.dart';
...
import 'package:qalbitech/core/consent/consent_service.dart';
import 'package:qalbitech/core/services/fcm_service.dart';
import 'package:qalbitech/firebase_options.dart';
import 'package:qalbitech/widgets/adabtiveBanner.dart';
...
import 'package:qalbitech/core/services/performance_service.dart';
import 'package:qalbitech/core/services/version_check_service.dart';
import 'package:qalbitech/core/services/version_check_controller.dart';
import 'package:qalbitech/routes/app_pages.dart';
...
class qalbitechApp extends StatelessWidget {
  const qalbitechApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 qalbitechApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 qalbitechApp - IsDark: ${themeSvc.isDark}");
