...
import 'package:tenatech/modules/post_detail/post_detail_page.dart';
...
import 'package:tenatech/firebase_options.dart';
...
import 'package:tenatech/core/services/performance_service.dart';
import 'package:tenatech/core/services/version_check_service.dart';
import 'package:tenatech/core/services/version_check_controller.dart';
import 'package:tenatech/routes/app_pages.dart';
...
class TenaTechApp extends StatelessWidget {
  const TenaTechApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 TenaTechApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 TenaTechApp - IsDark: ${themeSvc.isDark}");
