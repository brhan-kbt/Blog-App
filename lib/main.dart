...
import 'package:melatech/modules/post_detail/post_detail_page.dart';
...
import 'package:melatech/core/consent/consent_service.dart';
import 'package:melatech/core/services/fcm_service.dart';
import 'package:melatech/firebase_options.dart';
...
import 'package:melatech/core/services/performance_service.dart';
import 'package:melatech/core/services/version_check_service.dart';
import 'package:melatech/core/services/version_check_controller.dart';
import 'package:melatech/routes/app_pages.dart';
...
class MelaTech extends StatelessWidget {
  const MelaTech({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 MelaTech - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 MelaTech - IsDark: ${themeSvc.isDark}");
