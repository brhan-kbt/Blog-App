...
import 'package:totalpro/modules/post_detail/post_detail_page.dart';
...
import 'package:totalpro/core/consent/consent_service.dart';
import 'package:totalpro/core/services/fcm_service.dart';
import 'package:totalpro/firebase_options.dart';
import 'package:totalpro/widgets/adabtiveBanner.dart';
...
import 'package:totalpro/core/services/performance_service.dart';
import 'package:totalpro/core/services/version_check_service.dart';
import 'package:totalpro/core/services/version_check_controller.dart';
import 'package:totalpro/routes/app_pages.dart';
...
class TotalProApp extends StatelessWidget {
  const TotalProApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 TotalProApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 TotalProApp - IsDark: ${themeSvc.isDark}");
