...
import 'package:sheger_tech/firebase_options.dart';
...
import 'package:sheger_tech/core/services/performance_service.dart';
import 'package:sheger_tech/core/services/version_check_service.dart';
import 'package:sheger_tech/core/services/version_check_controller.dart';
import 'package:sheger_tech/routes/app_pages.dart';
...
class ShegerTechApp extends StatelessWidget {
  const ShegerTechApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 ShegerTechApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 ShegerTechApp - IsDark: ${themeSvc.isDark}");
