...
import 'package:ormitech/modules/post_detail/post_detail_page.dart';
...
import 'package:ormitech/core/consent/consent_service.dart';
import 'package:ormitech/core/services/fcm_service.dart';
import 'package:ormitech/firebase_options.dart';
import 'package:ormitech/widgets/adabtiveBanner.dart';
...
import 'package:ormitech/core/services/performance_service.dart';
import 'package:ormitech/core/services/version_check_service.dart';
import 'package:ormitech/core/services/version_check_controller.dart';
import 'package:ormitech/routes/app_pages.dart';
...
class OrmiTechApp extends StatelessWidget {
  const OrmiTechApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 OrmiTechApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 OrmiTechApp - IsDark: ${themeSvc.isDark}");
