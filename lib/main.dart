...
import 'package:kelotech/modules/post_detail/post_detail_page.dart';
...
import 'package:kelotech/core/consent/consent_service.dart';
import 'package:kelotech/core/services/fcm_service.dart';
import 'package:kelotech/firebase_options.dart';
import 'package:kelotech/widgets/adabtiveBanner.dart';
import 'package:permission_handler/permission_handler.dart';

import 'package:kelotech/core/theme/app_palette.dart';
import 'package:kelotech/core/theme/theme_service.dart';
import 'package:kelotech/core/services/connectivity_service.dart';
import 'package:kelotech/core/services/performance_service.dart';
import 'package:kelotech/core/services/version_check_service.dart';
import 'package:kelotech/core/services/version_check_controller.dart';
import 'package:kelotech/routes/app_pages.dart';
...
class kelotechApp extends StatelessWidget {
  const kelotechApp({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      debugPrint(
        "🎨 kelotechApp - Building with theme mode: ${themeSvc.mode.value}",
      );
      debugPrint("🎨 kelotechApp - IsDark: ${themeSvc.isDark}");
