...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  static const AppPalette light = AppPalette(
    primary: Color.fromARGB(255, 255, 0, 0), // e94873
    searchBg: Color.fromARGB(255, 252, 254, 255), // soft blue-tint chip
    searchOutline: Color.fromARGB(255, 255, 0, 0), // slate-300-ish hairline
    searchIcon: Color.fromARGB(255, 255, 0, 0), // e94873
    chipBg: Color.fromARGB(255, 168, 168, 168), // slate-50/100
    cardBg: Colors.white, // cards, tiles
    favoriteActive: Color.fromARGB(255, 255, 0, 0), // matches your seed
  );
