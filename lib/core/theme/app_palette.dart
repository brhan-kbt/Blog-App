...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  static const AppPalette light = AppPalette(
    primary: Color(0xFF443254), // e94873
    searchBg: Color.fromARGB(255, 252, 254, 255), // soft blue-tint chip
    searchOutline: Color(0xFF443254), // slate-300-ish hairline
    searchIcon: Color(0xFF443254), // e94873
    chipBg: Color.fromARGB(255, 168, 168, 168), // slate-50/100
    cardBg: Colors.white, // cards, tiles
    favoriteActive: Color.fromARGB(255, 211, 137, 157), // matches your seed
  );
  ...
  static const AppPalette dark = AppPalette(
    ...
    cardBg: Color.fromARGB(255, 6, 1, 2),
    favoriteActive: Color.fromARGB(255, 26, 8, 10), // matches your seed
  );
