...
class AppPalette extends ThemeExtension<AppPalette> {
  ...
  static const AppPalette light = AppPalette(
    primary: Color(0xFF145663), // e94873
    searchBg: Color.fromARGB(255, 252, 254, 255), // soft blue-tint chip
    searchOutline: Color(0xFF145663), // slate-300-ish hairline
    searchIcon: Color(0xFF145663), // e94873
    chipBg: Color.fromARGB(255, 168, 168, 168), // slate-50/100
    cardBg: Colors.white, // cards, tiles
    favoriteActive: Color.fromARGB(255, 157, 227, 239), // matches your seed
  );

  /// Explicit DARK palette
  static const AppPalette dark = AppPalette(
    primary: Color(0xFFD3D3D3), // e94873
    searchBg: Color.fromARGB(255, 30, 46, 46), // soft blue-tint chip
    ...
    favoriteActive: Color.fromARGB(255, 8, 22, 26), // matches your seed
  );
