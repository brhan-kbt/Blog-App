class ApiConfig {
  static const String baseUrl1 = "https://freshtips.techomia.xyz";
  static const String baseUrl = "https://freshtips.techomia.xyz/api/v1";
  static const String imageUrl = "https://freshtips.techomia.xyz/storage/";
