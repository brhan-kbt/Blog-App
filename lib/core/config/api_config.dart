class ApiConfig {
  static const String baseUrl1 = "https://superpro.techomia.xyz";
  static const String baseUrl = "https://superpro.techomia.xyz/api/v1";
  static const String imageUrl = "https://superpro.techomia.xyz/storage/";
