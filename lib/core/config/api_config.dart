class ApiConfig {
  static const String baseUrl1 = "https://tenatips.techomia.xyz";
  static const String baseUrl = "https://tenatips.techomia.xyz/api/v1";
  static const String imageUrl = "https://tenatips.techomia.xyz/storage/";
