class ApiConfig {
  static const String baseUrl1 = "https://totalpro.techomia.xyz";
  static const String baseUrl = "https://totalpro.techomia.xyz/api/v1";
  static const String imageUrl = "https://totalpro.techomia.xyz/storage/";
